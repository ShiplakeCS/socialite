...
oauth = OAuth(keys.ACCESS_TOKEN, keys.ACCESS_SECRET, keys.CONSUMER_KEY, keys.CONSUMER_SECRET)
...
try:
    f = open('trigger.txt','r')
    TRIGGER_TEXT = f.readline().rstrip("\n")
except:
    print("Unable to load trigger text file")

#testTweets()
realTweets()
# unnecesssary addition
# simpleMode()
